...
import PageTransitionWrapper from "../components/PageTransitionWrapper"; // Import the page transition wrapper
...
export default function RootLayout({ children }) {
    return (
        <html lang="en">
            ...
            >
                <AnimatedBackground />{" "}
                {/* Stays outside transitions, fixed background */}
                <Navbar /> {/* Stays outside transitions, fixed navbar */}
                <SmoothScrollApplier>
                    <PageTransitionWrapper>{children}</PageTransitionWrapper>{" "}
                    {/* Page content transitions here */}
                </SmoothScrollApplier>
